package net.takeout.moreores.gui.components;
...
public class LogoRenderer {
    public static final ResourceLocation TAKEOUTSMOREORES = new ResourceLocation("textures/gui/title/takeoutsmoreores.png");
    ...
    public void renderLogo(GuiGraphics pGuiGraphics, int pScreenWidth, float pTransparency, int pHeight) {
        ...
        pGuiGraphics.blit(this.showEasterEgg ? EASTER_EGG_LOGO : TAKEOUTSMOREORES, i, pHeight, 0.0F, 0.0F, 256, 44, 256, 64);
